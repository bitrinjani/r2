...
test('Test BARouter fetchQuotes', async () => {
...
test('Test BARouter cancel', async () => {
  const order = new Order(Broker.Bitflyer, OrderSide.Buy, 0.001, 500000, 
    CashMarginType.Cash, OrderType.Limit, 0);
...
test('Test BARouter getBtcPosition', async () => {
...
test('Test BARouter refresh', async () => {
