...
function nocksetup() {
  ...
  api
    ...
    .reply(200, [
      ...
      { currency_code: 'BTC', amount: 0.01084272, available: 0.01084272 },
      { currency_code: 'BCH', amount: 0.00047989, available: 0.00047989 },
  ...
  api
    ...
    .reply(200, [
      { currency_code: 'JPY', amount: 100, available: 100 },
      { currency_code: 'MOCK', amount: 0.01084272, available: 0.01084272 },
      { currency_code: 'BCH', amount: 0.00047989, available: 0.00047989 },
      { currency_code: 'ETH', amount: 0, available: 0 },
      { currency_code: 'ETC', amount: 0, available: 0 },
      { currency_code: 'LTC', amount: 0, available: 0 },
  ...
  api
    .get('/v1/me/getchildorders?child_order_acceptance_id=JRF20171103-092007-284294')
    .reply(200, [
      {
        id: 149550970,
    ...
    api
    .get('/v1/me/getchildorders?child_order_acceptance_id=JRF12345')
    .reply(200, [
      {
        id: 149550970,
  ...
  api.get('/v1/me/getchildorders?child_order_acceptance_id=MOCK').reply(200, []);
  api
    .get('/v1/me/getexecutions?child_order_acceptance_id=JRF20171103-092007-284294')
    .reply(200, [
      {
        id: 64923644,
        side: 'SELL',
    ...
    api
    .get('/v1/me/getexecutions?child_order_acceptance_id=JRF12345')
    .times(10)
    .reply(200, []);
